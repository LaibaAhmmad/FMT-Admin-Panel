                 ...
                 <div className="flex-1 ml-15 md:ml-0 overflow-x-hidden ">
                          <Navbar heading="VA Monitoring"/>
                               ...
                               <div className={`${poppins.className}  mt-[30px]  mx-[33px] flex lg:flex-row flex-col gap-x-4 `}>
                                <div>
                             <div className='bg-white rounded  w-full lg:w-[247px] h-[247px] relative '>
                            <div className='bg-[#FF9900] p-8 rounded-t'></div>
                            <div className='rounded-full bg-[#FFDAB9]  p-2 left-1/2   absolute  transform -translate-x-1/2 -translate-y-1/2 '><Image src={pp2} alt="not found"/></div>
                             <div className={` mt-7`}>
                              <h1 className="text-center font-semibold text-lg ">Rashel M.</h1>
                              <p className='text-[#B4B4B4] font-normal text-xs text-center'>Details</p>
                             </div>
                             </div>
                            <div className='bg-white  w-full lg:w-[247px] rounded h-[153px] text-center mt-[13px]'>
                            ...
                            <div className='  '>
                              <div className='bg-white rounded lg:max-w-[869px] w-full lg:h-[170px] h-auto  mt-3 lg:mt-0 pb-4 md:pb-0'>
                              ...
                              <input className='bg-[#F5F5F5] h-[35px]  w-full  rounded '/><span className='font-bold'>to</span>< input className=' h-[35px] w-full  bg-[#F5F5F5]  rounded '/> 
                              <button className='bg-[#FF9900]   text-white md:px-[18px] px-0 w-full h-[35px] rounded mt-2 md:mt-0'>Submit</button>
                              </div>
                              </div>
                             
                            </div>
                            <div className='bg-white rounded px-[25px]  lg:max-w-[869px] w-full lg:h-[560px] h-auto pb-3 md:pb-0'>
                            ...
                            <Image src={productImage} alt='not found' className='w-full'/>
                            </div>
                            </div>
                               </div>
                               </div>
